...
$mhs = new NilaiMhs ("Data Warehouse", 0, 0);

if (isset($_POST['tombol'])) {

  $mhs->matakuliah = $_POST['matkul'];
  $mhs->nim = $_POST['nim'];
  ...
  <div class="container">
    ...
    <div class="container-fluid">
      ...
      <div class="row mx-1">
        ...
        <span>Nama Mata kuliah: <?= $mhs->matakuliah; ?> </span>
        <span>Nilai : <?= $mhs->nilai; ?> </span>
        <span>Hasil Ujian: <?= $mhs->hasil(); ?></span>
        <span>Grade: <?= $mhs->grade(); ?> </span>
      </div>
      <hr>
    </div>
